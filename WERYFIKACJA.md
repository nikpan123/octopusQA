...
> Dokument historyczny: zapisuje wyniki wykonane 17.09.2026 i późniejsze poprawki techniczne. Nie jest raportem bieżącego zestawu. Aktualny katalog 298 scenariuszy znajduje się w [docs/tests/scenario-index.md](docs/tests/scenario-index.md), a dokumentacja obszarów w [docs/tests/README.md](docs/tests/README.md).
